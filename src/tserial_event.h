...
#define SERIAL_MAX_RX     1024       // Input buffer max size
#define SERIAL_MAX_TX     1024      // output buffer max size
...
public:
    ...
    void        run          (void);
                Tserial_event();
                ~Tserial_event();
    int         connect          (char *port, unsigned rate, unsigned ByteSize, int parity,
